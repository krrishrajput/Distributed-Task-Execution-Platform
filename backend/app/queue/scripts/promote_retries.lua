-- keys: retry_queue, priority_queue, sequence_key
...
local items = redis.call("ZRANGEBYSCORE", retry_queue, "-inf", current_time)
...
redis.call("ZREMRANGEBYSCORE", retry_queue, "-inf", current_time)
return #items
